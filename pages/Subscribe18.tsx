...
import styles from "./Subscribe18.module.css";
const Subscribe18: FunctionComponent = () => {
  ...
  const onGroupContainer31Click = useCallback(() => {
    navigate("/subscribe-1-9");
  }, [navigate]);

  return (
    <div className={styles.subscribe18}>
      ...
      <img
        className={styles.component20911}
        alt=""
      ...
      <div className={styles.subscribe18Child} />
      <div className={styles.groupContainer}>
        ...
        <div className={styles.groupParent1} onClick={onGroupContainer27Click}>
          <img className={styles.groupChild11} alt="" src="/group-175476.svg" />
          <div className={styles.next}>Next</div>
        </div>
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img className={styles.groupChild12} alt="" src="/group-175477.svg" />
        ...
        <div className={styles.groupFrame} onClick={onGroupContainer31Click}>
