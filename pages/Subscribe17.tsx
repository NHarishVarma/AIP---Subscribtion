...
import styles from "./Subscribe17.module.css";
const Subscribe17: FunctionComponent = () => {
  ...
  const onGroupContainer28Click = useCallback(() => {
    navigate("/subscribe-1-6");
  }, [navigate]);

  return (
    <div className={styles.subscribe17}>
      ...
      <div className={styles.subscribe17Child} />
      <div className={styles.groupContainer}>
        ...
        <div className={styles.groupParent1} onClick={onGroupContainer27Click}>
          <img className={styles.groupChild11} alt="" src="/group-175478.svg" />
          <div className={styles.next}>Next</div>
        </div>
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img className={styles.groupChild12} alt="" src="/group-175479.svg" />
        ...
        <div className={styles.howManyAdditional}>
          How many additional contacts would you like to add? If you select
          “More than 2”,you will have the opportunity to upload additional
          sheets in the documents section ​
        </div>
        ...
        <div className={styles.labelGroup}>
          <div className={styles.buttonNormal}>
            ...
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.thomas}>None</div>
          </div>
          <div className={styles.iconNavigationArrowDropDow}>
            <div className={styles.buttonNormal} />
            <img className={styles.colorIcon} alt="" src="/-color1.svg" />
