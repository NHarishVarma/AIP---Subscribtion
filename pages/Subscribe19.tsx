...
import styles from "./Subscribe19.module.css";
const Subscribe19: FunctionComponent = () => {
  ...
  const onGroupContainer27Click = useCallback(() => {
    navigate("/subscribe-1-10");
  }, [navigate]);

  const onGroupContainer28Click = useCallback(() => {
    navigate("/subscribe-1-7");
  }, [navigate]);

  return (
    <div className={styles.subscribe19}>
      ...
      <div className={styles.subscribe19Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>Contacts​</b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>03/14</b>
          <div className={styles.rectangleWrapper}>
            <div className={styles.rectangleDiv} />
          </div>
        </div>
        <div className={styles.groupParent1} onClick={onGroupContainer27Click}>
          <img className={styles.groupChild11} alt="" src="/group-17547.svg" />
          <div className={styles.next}>Next</div>
        </div>
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img className={styles.groupChild12} alt="" src="/group-175471.svg" />
        ...
        <div className={styles.label2}>
          ...
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>Jonathan.a.Brassington@gmail.com​</div>
        </div>
        ...
        <div
          className={styles.enterTheContact}
        >{`Enter the contact information for the Investor’s primary contact. Most communications will be sent via email.   `}</div>
        <div className={styles.additionalContact}>Additional Contact</div>
        ...
        <div className={styles.label5}>
          ...
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>138 Waverly Circle</div>
        </div>
        ...
        <div className={styles.label8}>
          ...
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>(484) 919-0842​</div>
        </div>
        ...
        <div className={styles.label12}>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.emailAddress1}>Last Name</div>
        </div>
        <div className={styles.label13}>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.emailAddress1}>Address Line 2</div>
        </div>
        <div className={styles.label14}>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.emailAddress1}>Address Line 1</div>
        </div>
        <div className={styles.label15}>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.emailAddress1}>City</div>
        </div>
        <div className={styles.labelGroup}>
          <div className={styles.label16}>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.emailAddress1}>State</div>
          </div>
        ...
        <div className={styles.label17}>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.emailAddress1}>Phone Number</div>
        </div>
        <div className={styles.label18}>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.emailAddress1}>Zip Code</div>
        </div>
        <div className={styles.addAdditionalContacts}>
          Add additional contacts to your list.
        </div>
        <div className={styles.groupFrame}>
          <div className={styles.addContactParent}>
            <div className={styles.addContact}>Add Contact</div>
            <img
