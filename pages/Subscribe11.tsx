...
import styles from "./Subscribe11.module.css";
const Subscribe11: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribe11}>
      ...
      <div className={styles.subscribe11Child} />
