...
import styles from "./Subscribe16.module.css";
const Subscribe16: FunctionComponent = () => {
  ...
  const onGroupContainer28Click = useCallback(() => {
    navigate("/subscribe-1-5");
  }, [navigate]);

  return (
    <div className={styles.subscribe16}>
      ...
      <div className={styles.subscribe16Child} />
