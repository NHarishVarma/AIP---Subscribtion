...
import styles from "./SubscribeComplete.module.css";
const SubscribeComplete: FunctionComponent = () => {
  ...
  const onRectangle11Click = useCallback(() => {
    navigate("/subscribe-list-complete");
  }, [navigate]);

  const onIconMaterialClose1Click = useCallback(() => {
    navigate("/subscribe-list-complete");
  }, [navigate]);

  const onComponent21221Click = useCallback(() => {
    navigate("/subscribe-list-complete");
  }, [navigate]);

  return (
    <div className={styles.subscribeComplete}>
      ...
      />
      <div className={styles.subscribeCompleteChild} />
      <div className={styles.subscribeCompleteChild} />
      <div
      ...
      <div
        className={styles.subscribeCompleteInner}
      ...
      <div className={styles.groupParent1}>
        <div className={styles.bgGroup}>
          ...
          <img
            className={styles.iconMaterialClose1}
            alt=""
            src="/icon-materialclose.svg"
            onClick={onIconMaterialClose1Click}
          />
          <div className={styles.logoParent}>
            <div className={styles.logo1}>
              Please rate your AIP your experience.
            </div>
            <img
              className={styles.iconMaterialStarBorder}
              alt=""
              src="/icon-materialstarborder.svg"
            />
            <img
              className={styles.iconMaterialStarBorder1}
              alt=""
              src="/icon-materialstarborder.svg"
            />
            <img
              className={styles.iconMaterialStarBorder2}
              alt=""
              src="/icon-materialstarborder.svg"
            />
            <img
              className={styles.iconMaterialStarBorder3}
              alt=""
              src="/icon-materialstarborder.svg"
            />
            <img
              className={styles.iconMaterialStarBorder4}
              alt=""
              src="/icon-materialstarborder.svg"
            />
          </div>
        ...
        <div className={styles.logo2}>
          <p className={styles.isTheInvestor}>
            <b>You Have Completed Your Subscription to the:</b>
          </p>
          <p className={styles.consumerGoodsRetail}>
            Consumer Goods Retail Enhancement Fund
          </p>
        </div>
        <div className={styles.component21221} onClick={onComponent21221Click}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
        ...
        >{`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sit amet odio accumsan arcu posuere venenatis quis nec mauris. Nam consequat ullamcorper nisl, et blandit dolor blandit eget. `}</div>
        <div className={styles.thankYou}>Thank You!</div>
        <div className={styles.lineParent}>
          <div className={styles.lineDiv} />
          <div className={styles.groupChild11} />
          <div className={styles.subscriptionSubmittedParent}>
            <div className={styles.subscriptionSubmitted}>
              Subscription Submitted
            </div>
            <img className={styles.groupChild12} alt="" src="/ellipse-71.svg" />
            <img
          ...
          <div className={styles.approvedByFirmParent}>
            <div className={styles.subscriptionSubmitted}>Approved by Firm</div>
            <img
          ...
          <div className={styles.signedDocumentsSentToYourParent}>
            <div className={styles.signedDocumentsSent}>
              Signed Documents Sent To Your Inbox
            </div>
            <img
              className={styles.groupChild12}
              alt=""
