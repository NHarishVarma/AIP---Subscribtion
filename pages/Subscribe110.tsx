...
import styles from "./Subscribe110.module.css";
const Subscribe110: FunctionComponent = () => {
  ...
  const onGroupContainer27Click = useCallback(() => {
    navigate("/subscribe-1-11");
  }, [navigate]);

  const onGroupContainer28Click = useCallback(() => {
    navigate("/subscribe-1-8");
  }, [navigate]);

  return (
    <div className={styles.subscribe110}>
      ...
      <div className={styles.subscribe110Child} />
      <div className={styles.groupContainer}>
        ...
        <div className={styles.groupParent1} onClick={onGroupContainer27Click}>
          <img className={styles.groupChild11} alt="" src="/group-175474.svg" />
          <div className={styles.next}>Next</div>
        </div>
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img className={styles.groupChild12} alt="" src="/group-175475.svg" />
          <div className={styles.previous}>Previous</div>
        </div>
        <div className={styles.theFirstAdditional}>
          The first additional contact should receive the following copies of
          correspondence:​
        </div>
        <div className={styles.quarterlyAndAnnualReportsParent}>
          <div className={styles.quarterlyAndAnnual}>
        ...
        <div className={styles.quarterlyPartnersAndCapitaParent}>
          <div className={styles.quarterlyAndAnnual}>
            Quarterly Partner’s and Capital Statements​
          </div>
          <img
            className={styles.lightSelectionControls1}
            alt=""
        ...
        <div className={styles.taxInformationk1sParent}>
          <div className={styles.quarterlyAndAnnual}>Tax Information/K-1s​</div>
          <img
            className={styles.lightSelectionControls1}
            alt=""
            src="/light--selection-controls1-checkboxesb-deselected5-states.svg"
        ...
        <div className={styles.capitalCallNoticesParent}>
          <div className={styles.quarterlyAndAnnual}>Capital Call Notices​</div>
          <img
            className={styles.lightSelectionControls1}
            alt=""
            src="/light--selection-controls1-checkboxesb-deselected5-states.svg"
        ...
        <div className={styles.cashAndStockDistributionsParent}>
          <div className={styles.quarterlyAndAnnual}>
        ...
        <div className={styles.legalDocumentsParent}>
          <div className={styles.quarterlyAndAnnual}>Legal Documents​</div>
          <img
            className={styles.lightSelectionControls1}
            alt=""
            src="/light--selection-controls1-checkboxesb-deselected5-states.svg"
