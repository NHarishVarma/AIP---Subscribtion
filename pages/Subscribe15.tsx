...
import styles from "./Subscribe15.module.css";
const Subscribe15: FunctionComponent = () => {
  ...
  const onGroupContainer29Click = useCallback(() => {
    navigate("/subscribe-1-1");
  }, [navigate]);

  return (
    <div className={styles.subscribe15}>
      ...
      <div className={styles.subscribe15Child} />
