...
import styles from "./SubscribeQuestion43.module.css";
const SubscribeQuestion43: FunctionComponent = () => {
  ...
  const onGroupContainer28Click = useCallback(() => {
    navigate("/subscribe-question-4-2");
  }, [navigate]);

  return (
    <div className={styles.subscribeQuestion43}>
      ...
      <div className={styles.subscribeQuestion43Child} />
      <div className={styles.groupContainer}>
        ...
        <div className={styles.logoParent}>
          <b className={styles.logo1}>04/14</b>
...
export default SubscribeQuestion43;
