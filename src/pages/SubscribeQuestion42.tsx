...
import styles from "./SubscribeQuestion42.module.css";
const SubscribeQuestion42: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeQuestion42}>
      ...
      <div className={styles.subscribeQuestion42Child} />
...
export default SubscribeQuestion42;
