...
import styles from "./SubscribeQuestion13.module.css";
const SubscribeQuestion13: FunctionComponent = () => {
  ...
  const onGroupContainer27Click = useCallback(() => {
    navigate("/subscribe-question-14");
  }, [navigate]);
  ...
  return (
    <div className={styles.subscribeQuestion13}>
      ...
      <img
        className={styles.component20923}
        alt=""
      ...
      <div className={styles.subscribeQuestion13Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>Wiring Bank Status​</b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>13/14</b>
        ...
        <div className={styles.groupParent1} onClick={onGroupContainer27Click}>
          <img className={styles.groupChild12} alt="" src="/group-175474.svg" />
          <div className={styles.next}>Next</div>
        </div>
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img className={styles.groupChild13} alt="" src="/group-175475.svg" />
          <div className={styles.previous}>Previous</div>
        </div>
        <div className={styles.isTheBank}>
          Is the bank or other financial institution from which the Investor’s
          funds will be wired (the “Wiring Bank) located in the United States or
          another “FATF Country? As of the date hereof, the countries,
          territories and organizations (each, a “FATF Country) that make up the
          membership of the Financial Action Task Force are: Argentina,
          Australia, Austria, Belgium, Brazil Canada, China, Denmark, European
          Commission, Finland, France, Germany Greece Gulf Co-operation Council
          Hong Kong (China), Iceland, India, Ireland, Israel Italy, Japan,
          Kingdom of the Netherlands, Luxembourg Malaysia Mexico, New Zealand,
          Norway, Portugal, Republic of Korea, Russian Federation, Saudi Arabia,
          Singapore, South Africa, Spain, Sweden, Switzerland. Turkey, United
          Kingdom, and United States. (Source: www.fatf-gafi.org)​
        </div>
        <div className={styles.isTheInvestor}>
          Is the Investor a customer of the Wiring Bank?​
        </div>
      </div>
...
export default SubscribeQuestion13;
