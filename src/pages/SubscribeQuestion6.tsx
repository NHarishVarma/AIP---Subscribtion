...
import styles from "./SubscribeQuestion6.module.css";
const SubscribeQuestion6: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeQuestion6}>
      ...
      <img
        className={styles.component20916}
        alt=""
      ...
      <div className={styles.subscribeQuestion6Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>Identification of Investor Status​</b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>06/14</b>
        ...
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img
            ...
            alt=""
            src="/group-1754719.svg"
          />
          <div className={styles.previous}>Previous</div>
        </div>
        <div className={styles.isTheInvestor}>
          Is the investor a “U.S. Person “ as defined in Rule 902(k) promulgated
          under the United States Securities Act of 1933, as amended (the
          “Securities Act”)?Additional information regarding Rule 902(k)
          promulgated under the securities act may be fount in Exhibit A to this
          Investor Questionnaire.​
        </div>
        <div className={styles.isTheInvestor1}>
          Is the Investor a “United States person” as defined as section
...
export default SubscribeQuestion6;
