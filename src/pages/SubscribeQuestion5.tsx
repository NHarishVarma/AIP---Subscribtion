...
import styles from "./SubscribeQuestion5.module.css";
const SubscribeQuestion5: FunctionComponent = () => {
  ...
  const onGroupContainer28Click = useCallback(() => {
    navigate("/subscribe-question-4-3");
  }, [navigate]);

  return (
    <div className={styles.subscribeQuestion5}>
      ...
      <img
        className={styles.component20914}
        alt=""
      ...
      <div className={styles.subscribeQuestion5Child} />
      <div className={styles.groupContainer}>
        ...
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img
            ...
            alt=""
            src="/group-1754723.svg"
          />
          <div className={styles.previous}>Previous</div>
        </div>
        <div className={styles.provideWireInstructions}>
          Provide wire instructions for the transfer of any payments due from
          the Fund. The Investor may change these wire instructions but may be
          required to provide an appropriate signature guarantee by a qualified
          financial institution (note that a signature guarantee is different
          than a notarized signature). For “further credit to” enter the FFCT
          account name.​
        </div>
        <div className={styles.enterTheFor}>
          Enter the “for further credit to” account number​
        </div>
        <div className={styles.bankAddress}>Bank Address</div>
        ...
        <div className={styles.label2}>
          <div className={styles.bankName}>Street Address</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>1243</div>
        </div>
        <div className={styles.label3}>
          <div className={styles.bankName}>Account Name</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>Linda Brassington 2014Trust</div>
        </div>
        <div className={styles.label4}>
          <div className={styles.bankName}>Account Number</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>084301767​</div>
        </div>
        <div className={styles.label5}>
          <div className={styles.bankName}>Account Number</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>1110089997546001</div>
        </div>
        <div className={styles.label6}>
          <div className={styles.bankName}>{`City `}</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>Phoenixville</div>
        </div>
        <div className={styles.labelParent}>
          <div className={styles.buttonNormal}>
            <div className={styles.bankName}>State</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.thomas}>PA</div>
          </div>
        ...
        <div className={styles.label8}>
          ...
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>868-10171​</div>
        </div>
        <div className={styles.label9}>
          <div className={styles.bankName}>Zip Code</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.thomas}>19460</div>
        </div>
        <div className={styles.label10}>
          <div className={styles.bankName}>Country</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
...
export default SubscribeQuestion5;
