...
import styles from "./SubscribeQuestion9.module.css";
const SubscribeQuestion9: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeQuestion9}>
      ...
      <div className={styles.component21268}>
        <div className={styles.buttonNormal}>
      ...
      <div className={styles.subscribeQuestion9Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>Accredited Investor Representations​</b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>09/14</b>
        ...
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img
            ...
            alt=""
            src="/group-1754713.svg"
          />
          <div className={styles.previous}>Previous</div>
        </div>
        <div className={styles.theInvestorHerebyContainer}>
          <p
            className={styles.theInvestorHereby}
          >{`The Investor hereby represents and warrants that the Investor is an Accredited Investor under Rule 501 of Regulation D promulgated by the Securities and Exchange Commission and that the Investor qualifies as such because the Investor is `}</p>
          <p className={styles.theInvestorHereby}>&nbsp;</p>
          <p
            className={styles.theInvestorHereby}
          >{`(select all applicable choices) `}</p>
          <p className={styles.theInvestorHereby}>&nbsp;</p>
          <p
            className={styles.theInvestorHereby}
          >{`Refer to the footnotes in the linked pages for more information: `}</p>
        </div>
        <div className={styles.netWorthParent}>
          <div className={styles.netWorth}>Net Worth</div>
          <img
            className={styles.lightSelectionControls1}
            alt=""
            src="/light--selection-controls1-checkboxesb-deselected5-states.svg"
          />
        </div>
        <div className={styles.jointNetWorthParent}>
          <div className={styles.netWorth}>Joint Net Worth</div>
          <img
            className={styles.lightSelectionControls1}
            alt=""
            src="/light--selection-controls1-checkboxesb-deselected5-states.svg"
        ...
        <div className={styles.spousalEquivalentParent}>
          <div className={styles.netWorth}>Spousal Equivalent</div>
          <img
            className={styles.lightSelectionControls1}
            alt=""
            src="/light--selection-controls1-checkboxesb-deselected5-states.svg"
        ...
        <div className={styles.investmentsRevocableGrantParent}>
          <div
            className={styles.netWorth}
          >{`Investments” & Revocable Grantor Trust”`}</div>
          <img
            className={styles.lightSelectionControls1}
            alt=""
            src="/light--selection-controls1-checkboxesb-deselected5-states.svg"
        ...
        <div className={styles.professionalCertificationsParent}>
          <div
            className={styles.netWorth}
        ...
        <div className={styles.aTrustWithTotalAssetsInWrapper}>
          <div className={styles.aTrustWith}>
            A trust, with total assets in excess of $5,000,000not formed for the
...
export default SubscribeQuestion9;
