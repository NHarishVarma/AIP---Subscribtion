...
import styles from "./SubscribeQuestion3.module.css";
const SubscribeQuestion3: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeQuestion3}>
      ...
      <div className={styles.component21247}>
      ...
      <div className={styles.subscribeQuestion3Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>Authorized Signatories​</b>
        <div className={styles.whatIsThe}>
          {" "}
          What is the name of the authorized person signing on behalf of the
          Investor?
        </div>
        <div className={styles.whatIsThe1}>
          What is the title of the Authorized person signing on behalf of the
          Investor?  
        </div>
...
export default SubscribeQuestion3;
