...
import styles from "./SubscribeQuestion11.module.css";
const SubscribeQuestion11: FunctionComponent = () => {
  ...
  const onGroupContainer27Click = useCallback(() => {
    navigate("/subscribe-question-12");
  }, [navigate]);
  ...
  return (
    <div className={styles.subscribeQuestion11}>
      ...
      <div className={styles.subscribeQuestion11Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>
          CFIUS Foreign Person Status Representation​
        </b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>11/14</b>
        ...
        <div className={styles.groupParent1} onClick={onGroupContainer27Click}>
          <img className={styles.groupChild12} alt="" src="/group-175478.svg" />
          <div className={styles.next}>Next</div>
        </div>
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img className={styles.groupChild13} alt="" src="/group-175479.svg" />
          <div className={styles.previous}>Previous</div>
        </div>
        <div className={styles.theInvestorHereby}>
          The Investor hereby represents and warrants that the Investor is
          (select the applicable choice):​
        </div>
        <div className={styles.theInvestorRepresents}>
          The Investor represents and warrants that: Refer to the footnotes in
          the linked pages for more information: 13 investment fund” 14, voting
          interest​
        </div>
        <div className={styles.notAForeignPersonUnderAnyWrapper}>
          <div className={styles.notAForeign}>
            (5) Not a foreign person under any of the above definitions included
            in this Section or otherwise as defined under Section 721 of the
            Defense Production Act of 1950, as amended, including all
            implementing regulations thereof​
          </div>
        </div>
        <div className={styles.theInvestorIsNotAnInvestmWrapper}>
          <div className={styles.theInvestorIs}>
            (1) The Investor is not an investment fund and no national or
            subnational governments of a single foreign (i.e.., non-U.S.state
            holds a voting Interest, direct or indirect, of 49 percent or more
            in the Investor.​
          </div>
        </div>
      </div>
...
export default SubscribeQuestion11;
