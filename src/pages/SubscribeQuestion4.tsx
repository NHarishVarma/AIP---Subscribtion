...
import styles from "./SubscribeQuestion4.module.css";
const SubscribeQuestion4: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeQuestion4}>
      ...
      <div className={styles.subscribeQuestion4Child} />
...
export default SubscribeQuestion4;
