...
const SubscribeListComplete: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeListComplete}>
      ...
      <div className={styles.path11175Parent} onClick={onGroupContainer16Click}>
      ...
      <div
        ...
        onClick={onGroupContainer17Click}
      >
      ...
      <div
        ...
        onClick={onGroupContainer23Click}
      >
      ...
      <div
        ...
        onClick={onGroupContainer24Click}
      >
        <div className={styles.cfiusForeignPersonContainer}>
          Bank Information
        </div>
      ...
      <div
        ...
        onClick={onGroupContainer27Click}
      >
        <div className={styles.badActorDisqualification}>
          WIRING BANK STATUS​
        </div>
      ...
      <div
        ...
        onClick={onGroupContainer28Click}
      >
        <div className={styles.cfiusForeignPersonContainer}>
        ...
        <div className={styles.groupWrapper}>
          <div className={styles.groupWrapper}>
            ...
            <div className={styles.leftNavButton7}>
              <div className={styles.leftNavButtonChild5} />
              <img
