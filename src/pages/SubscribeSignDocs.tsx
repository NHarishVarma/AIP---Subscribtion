...
import styles from "./SubscribeSignDocs.module.css";
const SubscribeSignDocs: FunctionComponent = () => {
  ...
  const onComponent21285Click = useCallback(() => {
    navigate("/subscribe-complete");
  }, [navigate]);

  return (
    <div className={styles.subscribeSignDocs}>
      ...
      <div className={styles.subscribeSignDocsChild} />
      <div className={styles.groupContainer}>
        <img className={styles.navbarbgIcon} alt="" src="/group-17421.svg" />
        <b className={styles.logo}>
          <p
            className={styles.youveSubmittedAll}
          >{`You’ve submitted all the relevant information. `}</p>
          <p className={styles.youveSubmittedAll}>
            The next step is to confirm and sign.​
          </p>
        </b>
        <div className={styles.component21285} onClick={onComponent21285Click}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
            <div className={styles.continue}>Continue</div>
          </div>
        </div>
        <div className={styles.youreAlmostFinished}>
          You’re almost finished!​
        </div>
      </div>
      <div className={styles.osageVenturePartnersViLpParent}>
        <div className={styles.osageVenturePartners}>
          Osage Venture Partners VI, L.P. Subscription Document​
        </div>
        <div className={styles.sign}>Sign</div>
      </div>
      <div className={styles.irsFormW9Parent}>
        <div className={styles.printSign}>IRS Form W-9​</div>
        <div className={styles.signed}>Signed</div>
      </div>
      <div className={styles.printSignInsteadWrapper}>
        <div className={styles.printSign}>{`Print & Sign Instead​`}</div>
      </div>
    </div>
  );
};

export default SubscribeSignDocs;
