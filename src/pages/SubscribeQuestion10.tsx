...
import styles from "./SubscribeQuestion10.module.css";
const SubscribeQuestion10: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeQuestion10}>
      ...
      <div className={styles.subscribeQuestion10Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>Qualified Purchaser Representations​</b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>10/14</b>
        ...
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img
            ...
            alt=""
            src="/group-17547111.svg"
          />
          <div className={styles.previous}>Previous</div>
        </div>
        <div
          className={styles.theInvestorHereby}
        >{`The Investor hereby represents and warrants that the Investor is a Qualified Purchaser under Section 2(a)(51) of the 1940 Act and that the Investor qualifies as such because the Investor is (select all applicable choices) Refer to the footnotes in the linked pages for more information: 10. “investments” 11. “company” `}</div>
        <div className={styles.aTrustThatWasNotFormedFoWrapper}>
          <div className={styles.aTrustThat}>
            (3) A trust that was not formed for the specific purpose of
            investing in the Fund, and the trustee or other person authorized to
            make decisions with respect to the trust and each settlor or other
            person who has contributed assets to the trust, is a qualified
            purchaser described in clauses (1)(1. or (iv) of Section 2(a)(51) of
            the 1940 Act.​
          </div>
        </div>
      </div>
...
export default SubscribeQuestion10;
