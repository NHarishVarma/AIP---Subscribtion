...
import styles from "./SubscribeQuestion52.module.css";
const SubscribeQuestion52: FunctionComponent = () => {
  ...
  const onGroupContainer27Click = useCallback(() => {
  ...
  return (
    <div className={styles.subscribeQuestion52}>
      ...
      <img
        className={styles.component20915}
        alt=""
      ...
      <div className={styles.subscribeQuestion52Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>Banking Information</b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>05/14</b>
          <div className={styles.rectangleWrapper}>
            <div className={styles.rectangleDiv} />
          </div>
        </div>
        <div className={styles.groupParent1} onClick={onGroupContainer27Click}>
          <img
            className={styles.groupChild11}
            alt=""
            src="/group-1754720.svg"
          />
          <div className={styles.next}>Next</div>
        </div>
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img
            className={styles.groupChild12}
            alt=""
            src="/group-17547211.svg"
          />
          <div className={styles.previous}>Previous</div>
        </div>
        <div className={styles.provideWireInstructionsContainer}>
          <p className={styles.provideWireInstructions}>
            Provide wire instructions for the transfer of any payments due from
            the Fund. ​
          </p>
          <p className={styles.provideWireInstructions}>&nbsp;</p>
          <p className={styles.provideWireInstructions}>
            The Investor may change these wire instructions but may be required
            to provide an appropriate signature guarantee by a qualified
            financial institution (note that a signature guarantee is different
            than a notarized signature).​
          </p>
          <p className={styles.provideWireInstructions}>&nbsp;</p>
          <p className={styles.provideWireInstructions}>
            For “further credit to” enter the FFCT account name.​
          </p>
        </div>
        <div className={styles.theNameUnder}>
          The Name under which the account held. This typically matches the
          legal name of the Investor​
        </div>
        <div className={styles.forFurtherCredit1}>
          “For further credit to” is not required for the most bank accounts. It
          may be required if you are using a brokerage or transferring through
        ...
        <div className={styles.label1}>
          ...
          <div className={styles.merrillLynch}>Merrill Lynch​</div>
        </div>
        <div className={styles.label2}>
          <div className={styles.bankName}>Account Name</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.merrillLynch}>Linda Brassington</div>
        </div>
        <div className={styles.label3}>
          <div className={styles.bankName}>SWIFT Code</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.merrillLynch}>For further credit to​</div>
        </div>
        <div className={styles.label4}>
          <div className={styles.bankName}>Number</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.merrillLynch}>868-10171​</div>
        </div>
        <div className={styles.label5}>
          <div className={styles.bankName}>ABA (routing number)​</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.merrillLynch}>08431767​</div>
        </div>
      </div>
    </div>
  );
...
export default SubscribeQuestion52;
