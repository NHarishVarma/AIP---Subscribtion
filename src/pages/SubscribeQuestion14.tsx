...
import styles from "./SubscribeQuestion14.module.css";
const SubscribeQuestion14: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeQuestion14}>
      ...
      <div className={styles.component21280}>
        <div className={styles.buttonNormal}>
      ...
      <img
        className={styles.component20925}
        alt=""
      ...
      <div className={styles.subscribeQuestion14Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>Identification of Special Entities​</b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>14/14</b>
        ...
        <div className={styles.groupParent1} onClick={onGroupContainer27Click}>
          <img className={styles.groupChild12} alt="" src="/group-175472.svg" />
        ...
        <div className={styles.doesTheInvestor}>
          Does the Investor have any applicable exceptions to any of the
          responsibilities and warranties contained in the Investor
          Questionnaire in the Fund Agreement?​
        </div>
...
export default SubscribeQuestion14;
