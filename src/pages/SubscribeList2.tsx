...
import styles from "./SubscribeList2.module.css";
const SubscribeList2: FunctionComponent = () => {
  ...
  const onGroupContainer12Click = useCallback(() => {
    navigate("/subscribe-question-13");
  }, [navigate]);
  ...
  const onComponent2129Click = useCallback(() => {
    navigate("/subscribe-list-error");
  }, [navigate]);

  const onComponent21210Click = useCallback(() => {
  ...
  return (
    <div className={styles.subscribeList2}>
      <img className={styles.maskGroup35} alt="" src="/mask-group-35@2x.png" />
      <div className={styles.path11174Parent}>
        <img className={styles.path11174Icon} alt="" src="/path-11174.svg" />
        <div
      ...
      <div className={styles.subscribeList2Child} />
      <div
      ...
      <div className={styles.component2129} onClick={onComponent2129Click}>
        <div className={styles.buttonNormal}>
          <div className={styles.buttonNormalChild} />
          <div className={styles.submit}>Submit</div>
        </div>
      </div>
      <div className={styles.component21210} onClick={onComponent21210Click}>
        <div className={styles.buttonNormal}>
      ...
      <div className={styles.groupContainer}>
        ...
        <div className={styles.component21211}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
            <div className={styles.save}>Save</div>
          </div>
        </div>
        <div className={styles.component21212}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalItem} />
            <div className={styles.cancel}>Cancel</div>
          </div>
      ...
      <img
        className={styles.checkCircleFill1Wght400GraIcon}
        alt=""
      ...
      <div className={styles.groupParent1}>
        ...
        <div className={styles.selectTheApplicable1}>
          Select the applicable investor type​
        </div>
        <div className={styles.whatsTheInvestors7}>
          What’s the investor’s principal business address?​
        </div>
        <div className={styles.isTheInvestorContainer3}>
          <p
            className={styles.isTheInvestor}
          >{`Is the Investor a disregarded entity for U.S tax purposes (e.g., a grantor trust or an LLC with a `}</p>
          <p className={styles.isTheInvestor}>{`single owner​). `}</p>
        </div>
        <div className={styles.whatsTheInvestors8}>
          What’s the investor’s principal place (country) of business?​
        </div>
        <div className={styles.whatsTheInvestors9}>
          What’s the investor’s principal place (state) of business?​
        </div>
        <div className={styles.whatsTheInvestors10}>
          What’s the investor’s jurisdiction (country) of organization?​
        </div>
        <div className={styles.whatsTheInvestors11}>
          What’s the investor’s jurisdiction (state) of organization?​
        </div>
        <div className={styles.labelParent}>
          <div className={styles.buttonNormal}>
        ...
        <div className={styles.labelParent6}>
          <div className={styles.buttonNormal}>
            <div className={styles.entityType}>Entity Type</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.sCorporation}>Grantor Trust​</div>
        ...
        <div className={styles.labelParent7}>
          <div className={styles.buttonNormal}>
            <div className={styles.entityType}>Disregarded Entity</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.sCorporation}>Yes</div>
        ...
        <div className={styles.labelParent8}>
          <div className={styles.buttonNormal}>
            <div className={styles.entityType}>Country</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.sCorporation}>{`United States `}</div>
        ...
        <div className={styles.labelParent9}>
          <div className={styles.buttonNormal}>
            <div className={styles.entityType}>State</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.sCorporation}>Pennsylvania</div>
        ...
        <div className={styles.labelParent10}>
          <div className={styles.buttonNormal}>
            <div className={styles.entityType}>Country</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.sCorporation}>United States</div>
        ...
        <div className={styles.labelParent11}>
          <div className={styles.buttonNormal}>
            <div className={styles.entityType}>State</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.sCorporation}>Pennsylvania</div>
        ...
        <div className={styles.label23}>
          <div className={styles.entityType}>Last Name</div>
          <img className={styles.path297Icon22} alt="" src="/path-297.svg" />
          <div className={styles.smith1}>Smith</div>
        </div>
        ...
        <div className={styles.labelParent12}>
          <div className={styles.buttonNormal}>
            <div className={styles.entityType}>State</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.sCorporation}>NY</div>
        ...
        <div className={styles.label28}>
          <div className={styles.entityType}>Zip Code</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
          <div className={styles.sCorporation}>98765</div>
        </div>
        <div className={styles.component2123}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
            <div className={styles.save}>Save</div>
          </div>
        </div>
        <div className={styles.component2124}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalItem} />
            <div className={styles.cancel}>Cancel</div>
          </div>
