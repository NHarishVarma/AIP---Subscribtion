...
import styles from "./SubscribeQuestion8.module.css";
const SubscribeQuestion8: FunctionComponent = () => {
  ...
  return (
    <div className={styles.subscribeQuestion8}>
      ...
      <img
        className={styles.component20918}
        alt=""
      ...
      <div className={styles.subscribeQuestion8Child} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.logo}>“Bad Actor” Disqualification​</b>
        <div className={styles.logoParent}>
          <b className={styles.logo1}>08/14</b>
        ...
        <div className={styles.groupParent2} onClick={onGroupContainer28Click}>
          <img
            ...
            alt=""
            src="/group-1754715.svg"
          />
          <div className={styles.previous}>Previous</div>
        </div>
        <div className={styles.isTheInvestor}>
          Is the Investor subject to “Bad Actor” disqualification, as such term
          is used in Rule 506(d) of Regulation D promulgated by the Securities
          and Exchange Commission? Rule 506(d) disqualifies persons who have
          been convicted of certain felonies and misdemeanors or who have been
          subject to certain orders, judgments or decrees. The full text of Rule
          506(d) may be found in Exhibit B to this Investor Questionnaire​
        </div>
...
export default SubscribeQuestion8;
